...
// Define the agents in the pipeline
const AGENTS = [
{
id: ‘idea-generation’,
name: ‘Idea Generator’,
role: ‘Creative Strategist’,
description: ‘Generates innovative full-stack application ideas that solve real-world problems with clear business value.’,
icon: Lightbulb,
...
description: ‘Creates comprehensive requirements documents with user stories, functional specs, and technical recommendations.’,
icon: FileText,
bgColor: ‘bg-blue-500’,
},
{
...
description: ‘Generates production-ready boilerplate code for both frontend React components and backend Express servers.’,
icon: Code,
...
description: ‘Analyzes generated code for security vulnerabilities, performance issues, and suggests best practice improvements.’,
icon: Search,
...
description: ‘Creates detailed deployment strategies for modern cloud platforms with CI/CD pipelines and monitoring.’,
icon: Rocket,
...
description: ‘Develops comprehensive testing strategies including unit tests, integration tests, and E2E test scenarios.’,
icon: TestTube,
bgColor: ‘bg-pink-500’,
},
];
...
setAgentStatuses(AGENTS.reduce((acc, agent) => {
acc[agent.id] = ‘idle’;
return acc;
}, {}));
setAgentOutputs({});
...
const executeAgent = useCallback(async (agent, index, context = {}) => {
try {
...
```
  ...
  // Generate prompts based on agent type and context
  switch (agent.id) {
  ...
  <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-xl md:text-2xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
        Transform your ideas into production-ready applications using our advanced 
        AI agent pipeline. From concept to deployment in minutes.
      </p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-yellow-400">
                Please set your Google Gemini API key in the .env file to use this application.
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        >
          ...
          <span>
            {pipelineStatus === 'running' ? 'Agents are Working...' : 'Generate New App'}
          </span>
        </button>
        ...
        {(pipelineStatus === 'completed' || pipelineStatus === 'error') && (
          <button
            ...
            className="flex items-center space-x-2 px-6 py-3 bg-gray-700 hover:bg-gray-600 
                      text-white rounded-xl font-medium transition-colors duration-200"
          >
        ...
        <div className="mt-8">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gray-800/50 border border-gray-700">
            <div className={`w-2 h-2 rounded-full ${
              pipelineStatus === 'running' ? 'bg-blue-400 animate-pulse' :
              pipelineStatus === 'completed' ? 'bg-green-400' :
              pipelineStatus === 'error' ? 'bg-red-400' : 'bg-gray-400'
            }`} />
        ...
        {[
          {
            ...
            description: 'AI analyzes market trends and generates innovative app ideas with real business potential.',
            color: 'from-yellow-500 to-orange-500'
          },
          {
            step: '2',
            title: 'Requirements Analysis',
            description: 'Converts ideas into detailed specifications with user stories and technical requirements.',
            color: 'from-blue-500 to-cyan-500'
          },
          {
            step: '3',
            title: 'Code Generation',
            description: 'Creates production-ready React frontend and Express backend code architecture.',
            color: 'from-green-500 to-emerald-500'
          },
          {
            step: '4',
            title: 'Code Review',
            description: 'Analyzes code for security, performance, and best practices with improvement suggestions.',
            color: 'from-purple-500 to-pink-500'
          },
          {
            step: '5',
            title: 'Deployment Strategy',
            description: 'Plans cloud deployment with CI/CD pipelines, monitoring, and scalability considerations.',
            color: 'from-orange-500 to-red-500'
          },
          {
            step: '6',
            title: 'Testing Plan',
            description: 'Develops comprehensive testing strategies with unit, integration, and E2E test examples.',
