      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Revolutionizing app development with AI-powered agent collaboration. From idea to deployment in minutes, not months.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {['React', 'Vite', 'Tailwind CSS', 'Google Gemini', 'Lucide Icons'].map(tech => (
                <span key={tech} className="px-3 py-1 bg-gray-700/50 text-gray-300 text-xs rounded-full border border-gray-600/50">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <div className="border-t border-gray-700/50 mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="text-sm text-gray-400">© {new Date().getFullYear()} CrewAI Fusion. Powered by Google Gemini.</div>
          </div>
        </div>
      </div>
    </footer>
